...
const Footer = () => {
  ...
  const footerColumns = [
    ...
    },
    {
      ...
      links: [
        { name: "TCGplayer", url: "/tcgplayer" }
      ]
    },
    {
      title: "Stay connected",
      socialLinks: [
        { name: "Facebook", url: "https://www.facebook.com/ebay", icon: "facebook" },
        { name: "X (Twitter)", url: "https://twitter.com/ebay", icon: "twitter" }
      ]
    },
    {
      title: "About eBay",
      links: [
        ...
        { name: "News", url: "/news" },
        { name: "Deferred Prosecution Agreement with District of Massachusetts", url: "/dpa" },
          ...
          <div key={index} className="footer-column">
            ...
            {column.socialLinks && (
              <ul className="social-links">
                {column.socialLinks.map((socialLink, socialIndex) => (
                  <li key={socialIndex}>
                    <a href={socialLink.url}>
                      {socialLink.icon === 'facebook' && <span className="icon facebook">ƒ</span>}
                      {socialLink.icon === 'twitter' && <span className="icon twitter">𝕏</span>}
                      {socialLink.name}
                    </a>
                  </li>
                ))}
